// Particulate matters are the biggest contributors to Delhi pollution. The main reason behind the increase in the concentration 
// of PMs include vehicle emission by applying Odd Even concept for all types of vehicles. The vehicles with the odd last digit in the 
// registration number will be allowed on roads on odd dates and those with even last digit will on even dates.
...
public class p10
{
    public static void main(String gg[])
    {
        Scanner sc=new Scanner(System.in);
            ...
            System.out.print("Enter a values of arr : ");                                  //  T.C. = O(n)    S.C. = O(n)
            int arr[]=new int[n];
